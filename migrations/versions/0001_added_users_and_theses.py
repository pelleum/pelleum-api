...
def upgrade():
    ...
    op.create_index(op.f('ix_adoptions_thesis_id'), 'adoptions', ['thesis_id'], unique=False)
    ...
    op.create_index(op.f('ix_comments_thesis_id'), 'comments', ['thesis_id'], unique=False)
    ...
    op.create_index(op.f('ix_reactions_thesis_id'), 'reactions', ['thesis_id'], unique=False)
