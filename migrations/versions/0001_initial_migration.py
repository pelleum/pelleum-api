...
Revision ID: 0001
Revises: 
Create Date: 2022-03-21 22:32:09.456507
...
def upgrade():
    ...
    op.create_index('ix_user_id_asset_symbol_institution_id', 'assets', ['user_id', 'asset_symbol', 'institution_id'], unique=True)
    ...
    op.create_index(op.f('ix_posts_asset_symbol'), 'posts', ['asset_symbol'], unique=False)
    op.create_index(op.f('ix_posts_is_post_comment_on'), 'posts', ['is_post_comment_on'], unique=False)
    op.create_index(op.f('ix_posts_is_thesis_comment_on'), 'posts', ['is_thesis_comment_on'], unique=False)
    ...
    op.create_index(op.f('ix_rationales_thesis_id'), 'rationales', ['thesis_id'], unique=False)
    op.create_index(op.f('ix_rationales_user_id'), 'rationales', ['user_id'], unique=False)
